...
#todo group spatial data into for skopje into one Mun
```
...
ggplot(mkop.df2, aes(x = long, y = lat, group = group)) + 
  ...
  labs(x=" ", y=" ") + 
  theme_bw() + 
  scale_fill_brewer('Unemployment Rate (Jan 2011)', palette  = 'PuRd') + 
  coord_map() + 
